...
%% -- Damit der nächste Beitrag auf einer rechten Seite beginnt
%% -- Bitte nicht löschen
%% --
\ifthenelse{\boolean{Rom2Buch}}{%% -- Hardcopy
    \clearpage%
    \ifodd\value{page}%
        \relax% Schon auf ungerader Seite
    \else%
        \null\clearpage% Leere Seite einfügen
    \fi%
}{}	%% -- für Online nicht erforderlich
